    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TemporaryPassword = table.Column<string>(type: "text", nullable: false),
                    TenantiId = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Nutritionists_UserBase_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Patients_UserBase_UserId",
                        column: x => x.UserId,
                        principalTable: "UserBase",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    NutritionistId1 = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    TenantId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Nutritionists_NutritionistId",
                        column: x => x.NutritionistId,
                        principalTable: "Nutritionists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_Nutritionists_NutritionistId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointment_Nutritionists_NutritionistId",
                        column: x => x.NutritionistId,
                        principalTable: "Nutritionists",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MealPlan_Nutritionists_NutritionistId",
                        column: x => x.NutritionistId,
                        principalTable: "Nutritionists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MealPlan_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BodyFatPct = table.Column<decimal>(type: "numeric", nullable: false),
                    MuscleMassKg = table.Column<decimal>(type: "numeric", nullable: false),
                    WaistCm = table.Column<decimal>(type: "numeric", nullable: false),
                    HipCm = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientMeasurement", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatientMeasurement_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointment_NutritionistId",
                table: "Appointment",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealPlan_NutritionistId",
                table: "MealPlan",
                column: "NutritionistId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_NutritionistId",
                table: "Orders",
                column: "NutritionistId");

            migrationBuilder.CreateIndex(
                name: "IX_Orders_NutritionistId1",
                table: "Orders",
                column: "NutritionistId1");

            migrationBuilder.CreateIndex(
                name: "IX_PatientMeasurement_PatientId",
